module Syntax.CutProof.Soundness where
  {- STDLIB -}
  open import Nat
  ...
  cut-sound :
    ...
    botAG ≤S ⟦ Δ₁ ⟧L -S ⟦ Γ₁ ∷ A ⟧L ->
    botAG ≤S ⟦ Δ₂ ∷ A ⟧L -S ⟦ Γ₂ ⟧L ->
    botAG ≤S ⟦ union Δ₁ Δ₂ ⟧L -S ⟦ union Γ₁ Γ₂ ⟧L
  cut-sound Γ₁ Γ₂ Δ₁ Δ₂ A IH IH₁ = 
    ≤S-cong-l
      {botAG +S botAG}
      neutral-+S
      (≤S-cong-r
        {B = (⟦ Δ₁ ⟧L -S (⟦ Γ₁ ⟧L +S A)) +S ((⟦ Δ₂ ⟧L +S A) -S ⟦ Γ₂ ⟧L)}
        (beginₛ
          ⟦ Δ₁ ⟧L -S (⟦ Γ₁ ⟧L +S A) +S (⟦ Δ₂ ⟧L +S A) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  ((CC (⟦ Δ₁ ⟧L -S (⟦ Γ₁ ⟧L +S A))) +C (● -C (CC (⟦ Γ₂ ⟧L))))
                  commu-+S ⟩
          ⟦ Δ₁ ⟧L -S (⟦ Γ₁ ⟧L +S A) +S (A +S ⟦ Δ₂ ⟧L) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ asso-+S ⟩
          ((⟦ Δ₁ ⟧L -S (⟦ Γ₁ ⟧L +S A)) +S (A +S ⟦ Δ₂ ⟧L)) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (● -C (CC (⟦ Γ₂ ⟧L)))
                  (symₛ asso-+S) ⟩
          (⟦ Δ₁ ⟧L +S ((-S (⟦ Γ₁ ⟧L +S A)) +S (A +S ⟦ Δ₂ ⟧L))) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (((CC ⟦ Δ₁ ⟧L) +C (● +C (CC ((A +S ⟦ Δ₂ ⟧L))))) -C (CC ⟦ Γ₂ ⟧L))
                  -S-distri ⟩
          (⟦ Δ₁ ⟧L +S (((-S (⟦ Γ₁ ⟧L)) -S A) +S (A +S ⟦ Δ₂ ⟧L))) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (((CC ⟦ Δ₁ ⟧L) +C ●) -C (CC ⟦ Γ₂ ⟧L))
          ...
          (⟦ Δ₁ ⟧L +S ((((-S (⟦ Γ₁ ⟧L)) -S A) +S A) +S ⟦ Δ₂ ⟧L)) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (((CC ⟦ Δ₁ ⟧L) +C (● +C (CC ⟦ Δ₂ ⟧L))) -C (CC ⟦ Γ₂ ⟧L))
                  (symₛ asso-+S) ⟩
          (⟦ Δ₁ ⟧L +S (((-S (⟦ Γ₁ ⟧L)) +S ((-S A) +S A)) +S ⟦ Δ₂ ⟧L)) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (((CC ⟦ Δ₁ ⟧L) +C (((CC (-S ⟦ Γ₁ ⟧L)) +C ●) +C (CC ⟦ Δ₂ ⟧L))) -C (CC ⟦ Γ₂ ⟧L))
                  (transₛ
                    commu-+S
                    opp-+S) ⟩
          (⟦ Δ₁ ⟧L +S (((-S (⟦ Γ₁ ⟧L)) +S botAG) +S ⟦ Δ₂ ⟧L)) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (((CC ⟦ Δ₁ ⟧L) +C (● +C (CC ⟦ Δ₂ ⟧L))) -C (CC ⟦ Γ₂ ⟧L))
                  neutral-+S ⟩
          (⟦ Δ₁ ⟧L +S ((-S (⟦ Γ₁ ⟧L)) +S ⟦ Δ₂ ⟧L)) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (((CC ⟦ Δ₁ ⟧L) +C ●) -C (CC ⟦ Γ₂ ⟧L))
                  commu-+S ⟩
          (⟦ Δ₁ ⟧L +S (⟦ Δ₂ ⟧L -S ⟦ Γ₁ ⟧L)) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ ctxtₛ
                  (● -C (CC ⟦ Γ₂ ⟧L))
                  asso-+S ⟩
          ((⟦ Δ₁ ⟧L +S ⟦ Δ₂ ⟧L) -S ⟦ Γ₁ ⟧L) -S ⟦ Γ₂ ⟧L
            ≡ₛ⟨ symₛ asso-+S ⟩
          (⟦ Δ₁ ⟧L +S ⟦ Δ₂ ⟧L) +S ((-S ⟦ Γ₁ ⟧L) -S ⟦ Γ₂ ⟧L)
            ≡ₛ⟨ ctxtₛ
                  ((CC (⟦ Δ₁ ⟧L +S ⟦ Δ₂ ⟧L)) +C ●)
                  (symₛ -S-distri) ⟩
          (⟦ Δ₁ ⟧L +S ⟦ Δ₂ ⟧L) -S (⟦ Γ₁ ⟧L +S ⟦ Γ₂ ⟧L)
          ...
          ⟦ union Δ₁ Δ₂ ⟧L -S (⟦ Γ₁ ⟧L +S ⟦ Γ₂ ⟧L)
            ≡ₛ⟨ ctxtₛ
                  ((CC ⟦ union Δ₁ Δ₂ ⟧L) -C ●)
                  (symₛ sem-union-eq-plus) ⟩
          ⟦ union Δ₁ Δ₂ ⟧L -S ⟦ union Γ₁ Γ₂ ⟧L ∎ₛ)
        (A≤B=>C≤D=>A+C≤B+D
          IH
          IH₁))
  ...
  soundness (cut Γ₁ Γ₂ Δ₁ Δ₂ x p p₁) =
    cut-sound Γ₁ Γ₂ Δ₁ Δ₂ x (soundness p) (soundness p₁)
